    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-teal-50 overflow-hidden pt-20">
        <div className="absolute inset-0">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-teal-200/40 to-transparent rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gradient-to-tr from-cyan-200/40 to-transparent rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-fade-in-up">
              <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm border border-teal-200 px-4 py-2 rounded-full shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105">
                <Sparkles className="w-4 h-4 text-teal-600 animate-spin-slow" />
                <span className="text-sm font-bold text-teal-600">70+ Years of Excellence</span>
              </div>

              <div className="space-y-6">
                <h1 className="text-6xl lg:text-7xl font-black text-gray-900 leading-none animate-fade-in" style={{ animationDelay: '0.2s' }}>
                  Asian Supply
                  <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 via-cyan-500 to-green-500 animate-gradient">
                    Chain Gateway
                  </span>
                </h1>

                <p className="text-xl text-gray-700 leading-relaxed max-w-xl animate-fade-in" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-fade-in" style={{ animationDelay: '0.6s' }}>
                ...
                <button
                  ...
                  className="border-2 border-teal-500 text-teal-600 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-teal-50 transition-all duration-300 hover:scale-105"
                >
                  Explore More
                </button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                <div className="relative group animate-fade-in" style={{ animationDelay: '0.8s' }}>
                  ...
                  <div className="relative bg-white/80 backdrop-blur-sm border border-teal-100 rounded-2xl p-4 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="relative group animate-fade-in" style={{ animationDelay: '0.9s' }}>
                  ...
                  <div className="relative bg-white/80 backdrop-blur-sm border border-green-100 rounded-2xl p-4 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="relative group animate-fade-in" style={{ animationDelay: '1s' }}>
                  ...
                  <div className="relative bg-white/80 backdrop-blur-sm border border-cyan-100 rounded-2xl p-4 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="relative hidden lg:block w-full animate-fade-in-right" style={{ animationDelay: '0.4s' }}>
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-br from-teal-400/30 via-cyan-400/20 to-green-400/30 rounded-3xl blur-2xl group-hover:blur-3xl transition-all duration-500 animate-pulse"></div>
                <div className="relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02]">
                  <img
                    src="/2.png"
                    alt="Asian Supply Chain Team"
                    className="w-full h-auto object-cover transform group-hover:scale-105 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-teal-900/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-6 w-full mt-8">
                <div className="group relative bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden hover:-translate-y-2 animate-fade-in" style={{ animationDelay: '0.6s' }}>
                  ...
                  <div className="relative">
                    <div className="flex items-start space-x-4 mb-6">
                      <div className="relative">
                        <div className="absolute inset-0 bg-gradient-to-br from-teal-300 to-cyan-400 rounded-2xl blur-md opacity-50"></div>
                        <div className="relative w-16 h-16 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-110 transition-transform duration-300">
                    ...
                    <ul className="space-y-3">
                      {[
                        ...
                        <li key={idx} className="flex items-center space-x-3 group/item">
                          <div className="w-2 h-2 bg-teal-500 rounded-full flex-shrink-0 group-hover/item:scale-150 transition-transform duration-200"></div>
                          <span className="text-sm text-gray-700 font-medium group-hover/item:text-teal-600 transition-colors duration-200">{item}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                ...
                <div className="group relative bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden hover:-translate-y-2 animate-fade-in" style={{ animationDelay: '0.7s' }}>
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="relative">
                    <div className="flex items-start space-x-4 mb-6">
                      <div className="relative">
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-300 to-sky-400 rounded-2xl blur-md opacity-50"></div>
                        <div className="relative w-16 h-16 bg-gradient-to-br from-blue-500 to-sky-600 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-110 transition-transform duration-300">
                    ...
                    <ul className="space-y-3">
                      {[
                        ...
                        <li key={idx} className="flex items-center space-x-3 group/item">
                          <div className="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0 group-hover/item:scale-150 transition-transform duration-200"></div>
                          <span className="text-sm text-gray-700 font-medium group-hover/item:text-blue-600 transition-colors duration-200">{item}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
